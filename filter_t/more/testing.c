...
int main(int argc, char *argv[])
{
    ...
    // Image with varying colors for edge detection
    RGBTRIPLE img4[3][3];
    ...
    RGBTRIPLE img5[4][4];
    img5[0][0] = pixel(0, 10, 25);
    img5[0][1] = pixel(0, 10, 30);
    img5[0][2] = pixel(40, 60, 80);
    img5[0][3] = pixel(50, 60, 80);
    img5[1][0] = pixel(20, 30, 90);
    img5[1][1] = pixel(30, 40, 100);
    img5[1][2] = pixel(80, 70, 90);
    img5[1][3] = pixel(80, 80, 90);
    img5[2][0] = pixel(20, 20, 40);
    img5[2][1] = pixel(30, 10, 30);
    img5[2][2] = pixel(50, 40, 10);
    img5[2][3] = pixel(50, 40, 100);
    img5[3][0] = pixel(50, 20, 40);
    img5[3][1] = pixel(50, 20, 40);
    img5[3][2] = pixel(50, 40, 80);
    img5[3][3] = pixel(50, 40, 80);
