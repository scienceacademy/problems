...
def lock_pairs1():
    ...
    check50.run("./tideman_test 5 16").stdout(
        "false false false true false true false false false false false false false false false false false false false true false false true false false ").exit(0)
...
def lock_pairs3():
    ...
    check50.run("./tideman_test 5 15").stdout(
        "false false false false false false false false true false true false false false false false false false false false false true true false false ").exit(0)
